...
class TitleViewModel(private val animeTitleRepository : AnimeTitleRepository) : ViewModel() {
    ...
    // TODO: Хардкод в поиске по URL
    fun getTitleByUrl() {
        viewModelScope.launch {
            val url = "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.fortressofsolitude.co.za%2Fwp-content%2Fuploads%2F2021%2F06%2F5-Most-Popular-Anime-Characters-of-All-Time.jpg&f=1&nofb=1&ipt=3f8bda4ba5920ca7963c49ed4b302d87062662f2391a1e7ea59832fa222925e8&ipo=images"
            uiState = AnimeUiState.Loading
            uiState = try {
                AnimeUiState.Success(
                    animeTitleRepository.getAnimeTitlePhoto(url)
                )
            } catch (_: IOException) {
                AnimeUiState.Error
            }
